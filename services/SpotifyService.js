...
class SpotifyService {
    constructor() {
        this.sp_dc = "AQBjVxf81hHa0xaJr_j3ly1u-aYq8hAutMXHRrKo12bAG28YiXISdC9NEIQgDvxYE1oyo-a9rpVTt9aSK0kY0dtOinwW8bcsVlxzmol0wNFLxFU77Jg-ifW4QezLwlfNXA7coeoNeg-Hec8gcqTaBaxaZCwR99ODswEwRcUVcwrNMj323_8QJCuJeMhnGVNT89bv6XHHOcLpoZZ9Bf4Nn3S42Pxo";
    ...
    addUserToRoom(roomId, userId, socketId) {
        try {
            ...
            // malas baca console.error('Error adding user to room:', error);
        }
    }
    ...
    removeUserBySocketId(socketId) {
        try {
            ...
            // malas baca console.error('Error removing user by socket ID:', error);
        }
    }
